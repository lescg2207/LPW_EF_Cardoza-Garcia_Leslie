...
<body>
	...
	<div class="container">
		<img src="images/f-actas.jpg" width="1170" height="248"
				...
				<div class="col-xs-12 col-md-9" id="impreso">
					<div class="contenido-interna">
						...
						<div class="col-xs-12 td34up">
							<form id="frmBuscar" name="frmBuscar" action="svlActas"
										...
										<div class="form-group">
											...
											<div id="departamentos">
												<select name="cboDepartamento" id="cboDepartamento"
													...
													<option <%=(aDPD[0].equals("-1") ? "selected" : "")%>
													...
													%>
													<option
														<%=(aDPD[0].equals(aDepartamento[0]) ? "selected" : "")%>
														value="<%=aDepartamento[0]%>"><%=aDepartamento[1]%></option>
													<%
													}
													}
													%>
										...
										<div class="form-group">
											...
											<div id="provincias">
												<select id="cboProvincia" name="cboProvincia"
													class="form-control"
													onchange="javascript:document.frmBuscar.submit()"
													<%=aDPD[0].equals("-1") ? "disabled" : ""%>>
													<option <%=(aDPD[1].equals("-1") ? "selected" : "")%>
														value="-1">--SELECCIONE--</option>
													...
													%>
													<option
														<%=(aDPD[1].equals(aProvincia[0]) ? "selected" : "")%>
														value="<%=aProvincia[0]%>"><%=aProvincia[1]%></option>
													<%
													}
													}
													%>
								...
								<div class="row">
									<div class="col-md-4">
										...
										<div id="distritos" class="form-group">
											<select id="cboDistrito" name="cboDistrito"
												class="form-control"
												onchange="javascript:document.frmBuscar.submit()"
												<%=aDPD[1].equals("-1") ? "disabled" : ""%>>
												<option <%=(aDPD[2].equals("-1") ? "selected" : "")%>
													value="-1">--SELECCIONE--</option>
												...
												%>
												<option
													<%=(aDPD[2].equals(aDistrito[0]) ? "selected" : "")%>
													value="<%=aDistrito[0]%>"><%=aDistrito[1]%></option>
												<%
												}
												}
												%>
									...
									<div class="col-md-8">
										<div class="form-group">
											...
											<div id="localVotacion">
												<select id="cboLocalVotacion" name="cboLocalVotacion"
													class="form-control"
													onchange="javascript:document.frmBuscar.submit()"
													<%=aDPD[2].equals("-1") ? "disabled" : ""%>>
													<option <%=(aDPD[3].equals("-1") ? "selected" : "")%>
														value="-1">--SELECCIONE--</option>
													...
													%>
													<option <%=(aDPD[3].equals(aLocal[0]) ? "selected" : "")%>
														value="<%=aLocal[0]%>"><%=aLocal[1]%></option>
													<%
													}
													}
													%>
									...
									<div id="divDetalle" class="ptop20">
													...
													<tbody>
														...
														%><tr>
															...
															<td bgcolor="#C1C1C1" style="cursor: pointer"><a
																href="svlActas?nroMesa=<%=mesa%>"><%=mesa%></a></td>
										...
										<div
											class="col-xs-12 cont-recto oculto-leyenda-color-fondo-mesas">
											<div class="col-md-4">
												<img src="images/procesacon.jpg"> Procesada con imagen
											</div>
											<div class="col-md-4">
												<img src="images/procesasin.jpg"> Procesada sin imagen
											</div>
											<div class="col-md-4">
												<img src="images/sinprocesa.jpg"> Sin procesar
											</div>
										</div>
											...
											<div class="col-lg-8 centered">
												<div class="col-xs-12 col-md-12 col-lg-12">
													...
													<table>
														<tbody>
															<tr>
																<td colspan="10"><div class="conte-paginador">
						...
						<form id="myform" name="myform" class="horizontal-form"
							method="post" action="svlActas?id=">
							<p>&nbsp;</p>
							...
							<div class="col-md-4">
								<div class="form-group">
									<span id="spanNroMesa"> <input id="nroMesa"
										name="nroMesa" type="text"
										onkeypress="return validText(this, event, 4)" maxlength="6"
